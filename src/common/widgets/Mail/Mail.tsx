  ...
  return (
    <motion.div variants={fadeTop} {...motionStep} id="__mail" className='fixed z-[999] bottom-0 right-[40px] hidden xl:block' >
        <div className='space-y-6 after:h-[90px] after:w-[1px] after:bg-slate-400 after:block after:mx-auto after:mt-6' >
           <Link href='mailto:mdiqbalhossain203050@gmail.com' className='text-[10px] text-slate-400 hover:text-sky-400 cursor-pointer transition-all duration-300 hover:translate-y-[-8px] rl' >mdiqbalhossain203050@gmail.com</Link> 
        </div>
    </motion.div>
  )
}
